...
Welcome to ``datathon2022`` contributor's guide.
...
If you experience bugs or general issues with ``datathon2022``, please have a look
...
You can help improve ``datathon2022`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``datathon2022`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``datathon2022``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n datathon2022 python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/datathon2022.git
    cd datathon2022
...
#. Install |pre-commit|_::
   ...
   ``datathon2022`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/datathon2022
.. _issue tracker: https://github.com/<USERNAME>/datathon2022/issues
.. <-- end -->
